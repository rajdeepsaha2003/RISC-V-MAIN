#include "isim/work/tb___i_f_u/tb___i_f_u.h"
#include "isim/work/glbl/glbl.h"
static const char * HSimCopyRightNotice = "Copyright 2004-2005, Xilinx Inc. All rights reserved.";


#include "work/tb___i_f_u/tb___i_f_u.h"
static HSim__s6* IF0(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workMtb___i_f_u(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("tb_IFU", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        topvl = new workMtb___i_f_u("tb_IFU");
