#include "isim/work/_i_n_s_t___m_e_m__tb__v/_i_n_s_t___m_e_m__tb__v.h"
#include "isim/work/glbl/glbl.h"
static const char * HSimCopyRightNotice = "Copyright 2004-2005, Xilinx Inc. All rights reserved.";


#include "work/_i_n_s_t___m_e_m__tb__v/_i_n_s_t___m_e_m__tb__v.h"
static HSim__s6* IF0(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workM_i_n_s_t___m_e_m__tb__v(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("INST_MEM_tb_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("INST_MEM", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        topvl = new workM_i_n_s_t___m_e_m__tb__v("INST_MEM_tb_v");
