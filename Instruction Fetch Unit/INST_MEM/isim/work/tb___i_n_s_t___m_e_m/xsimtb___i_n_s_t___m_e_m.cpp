#include "isim/work/tb___i_n_s_t___m_e_m/tb___i_n_s_t___m_e_m.h"
#include "isim/work/glbl/glbl.h"
static const char * HSimCopyRightNotice = "Copyright 2004-2005, Xilinx Inc. All rights reserved.";


#include "work/tb___i_n_s_t___m_e_m/tb___i_n_s_t___m_e_m.h"
static HSim__s6* IF0(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workMtb___i_n_s_t___m_e_m(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("tb_INST_MEM", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("INST_MEM", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        topvl = new workMtb___i_n_s_t___m_e_m("tb_INST_MEM");
